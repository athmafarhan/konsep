 ...
 * @author Athma Farhan
 */
public class PinjamKembaliOutdoor {
    private int id;
    private int id_cust;
    ...
    public PinjamKembaliOutdoor() {
    }

    public PinjamKembaliOutdoor(int id, int id_cust, String nama_cust, int id_inventaris, String nama_inventaris, String tgl_sewa, String jam_sewa, String tgl_kembali, String jam_kembali, int harga, int dp, int diskon, int denda, int jml, String cara_bayar) {
        this.id = id;
