...
public class InventarisKamera {
    ...
    public InventarisKamera(int id, int id_tipe, String tipe, int id_merk, String merk, int id_jenis, String jenis, int harga, String warna, String string_warna, String pemilik) {
        this.id = id;
    ...
    public InventarisKamera(int id, String merk, String jenis, String string_warna, int harga) {
        this.id = id;
        this.merk = merk;
        this.jenis = jenis;
        this.string_warna = string_warna;
