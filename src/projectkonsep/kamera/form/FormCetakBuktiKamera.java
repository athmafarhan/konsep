 ...
 * @author Athma Farhan
 */
public class FormCetakBuktiKamera extends javax.swing.JFrame {
    ...
    ArrayList<CetakBuktiKamera> ListPeminjamanKamera = new ArrayList<>();
     ...
     * @param id_transaksi
     */
    public FormCetakBuktiKamera(int id_transaksi) {
        if (id_transaksi==0) {
            ...
            id_transaksi=FormCetakBuktiKamera.id_transaksi;
        }
        
        FormCetakBuktiKamera.id_transaksi=id_transaksi;
        initComponents();
        connectDatabasePeminjaman();
        tblPeminjamanKamera.getColumnModel().getColumn(0).setPreferredWidth(23);
        tblPeminjamanKamera.getColumnModel().getColumn(1).setPreferredWidth(120);
        tblPeminjamanKamera.getColumnModel().getColumn(2).setPreferredWidth(100);
        tblPeminjamanKamera.getColumnModel().getColumn(3).setPreferredWidth(45);
        tblPeminjamanKamera.getColumnModel().getColumn(4).setPreferredWidth(90);
        tblPeminjamanKamera1.getColumnModel().getColumn(0).setPreferredWidth(23);
        tblPeminjamanKamera1.getColumnModel().getColumn(1).setPreferredWidth(120);
        tblPeminjamanKamera1.getColumnModel().getColumn(2).setPreferredWidth(100);
        tblPeminjamanKamera1.getColumnModel().getColumn(3).setPreferredWidth(45);
        tblPeminjamanKamera1.getColumnModel().getColumn(4).setPreferredWidth(90);
    ...
    public void connectDatabasePeminjaman(){
        ...
        tblPeminjamanKamera1.setModel(dataPeminjaman);
        Statement st;
        ResultSet rs;
        System.out.println(id_transaksi);
        String viewPeminjaman = "select * from V_CetakBuktiKamera where `id`="+id_transaksi+"";
        int indexNomor = 1;
        Date tgl_sewa = null;
        ...
        int hargaJumlah = 0;
            ...
            hargaJumlah = 0;
            for (CetakBuktiKamera CBK : ListPeminjamanKamera) {
                hargaJumlah = CBK.getHarga()-CBK.getDiskon();
                jumlahDP+=CBK.getDp();
...
//                jpanel sing kon print  
    ...
    private void initComponents() {
        ...
        tblPeminjamanKamera1 = new javax.swing.JTable();
        ...
        tblPeminjamanKamera.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Jenis Kamera", "Keterangan", "Jumlah Hari", "Tanggal Kembali", "Harga Sewa"
            }
        ));
        ...
        jLabel15.setText("Bukti Penyewaan Kamera Konsep");
        ...
        tblPeminjamanKamera1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null},
                {null, null, null, null, null, null},
                {null, null, null, null, null, null},
        ...
        jScrollPane2.setViewportView(tblPeminjamanKamera1);
        ...
        jLabel68.setText("Bukti Penyewaan Kamera Konsep");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCetakBuktiKamera(id_transaksi).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblPeminjamanKamera1;
